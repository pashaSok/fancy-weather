export function createErrorPopup() {
    ...
    popup.className = 'fixed top-4 right-4 bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg hidden z-50 transition-all duration-300 transform translate-x-full';
